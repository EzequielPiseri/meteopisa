...
This outlines how to propose a change to meteopisa. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("EzequielPiseri/meteopisa", fork = TRUE)`.
...
Please note that the meteopisa project is released with a [Contributor
Code of
Conduct](https://ezequielpiseri.github.io/meteopisa/CODE_OF_CONDUCT.md).
